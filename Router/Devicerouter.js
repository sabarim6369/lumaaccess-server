...
const {segregatedevicedependonaccess,addownership,getConnectedDevices,handleSendCommand,sendRequest,acceptRequest,rejectRequest,allowedDevices,removeAccess,updatePermissionAccess,allowpermittedstuffs}=require("../controller/Devicecontroller")
